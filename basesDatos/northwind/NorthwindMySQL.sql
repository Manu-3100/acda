...
DELIMITER $$
CREATE DEFINER=`root`@`localhost` FUNCTION `nombreMes`(fecha datetime) RETURNS varchar(10) CHARSET latin1
begin
	declare mes int;
	...
	Case 
		when mes = 1 then set nombre = 'Enero';
		when mes = 2 then set nombre = 'Febrero';
		when mes = 3 then set nombre = 'Marzo';
		when mes = 4 then set nombre ='Abril';
		when mes = 5 then set nombre = 'Mayo';
		when mes = 6 then set nombre = 'Junio';
		when mes = 7 then set nombre = 'Julio';
		when mes = 8 then set nombre = 'Agosto';
		when mes = 9 then set nombre = 'Septiembre';
		when mes = 10 then set nombre = 'Octubre';
		when mes = 11 then set nombre = 'Noviembre';
		Else
			set nombre = 'Diciembre';
    end case;
...
DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `EmpleadosPorLugarTrabajo`(IN lugar Varchar(15), OUT contador INT)
BEGIN
